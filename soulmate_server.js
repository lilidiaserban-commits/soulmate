...
const STYLE_PORTRAIT = 'loose expressive fine-art watercolor portrait of a natural, realistic human face with true-to-life proportions, painted in luminous violet, purple and soft blue celestial tones (dreamy galaxy skin) with visible graphite pencil sketch lines and confident brushwork, tiny white star-sparkle highlights scattered in the hair and skin, gentle magenta and warm gold accents, on soft white watercolor paper with generous negative space, delicate paint splatters and color bleeds at the edges, ethereal celestial romantic mood, gallery-quality hand-painted watercolour, head-and-shoulders, beautiful';
