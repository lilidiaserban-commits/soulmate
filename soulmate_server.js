...
const STYLE_PORTRAIT = 'clean line-drawing watercolor portrait of a natural, realistic human face with true-to-life proportions, confident graphite and ink sketch outline, the watercolour color kept INSIDE the drawn figure so the face, hair and shoulders are filled with luminous violet, purple and soft blue celestial washes while the background stays clean untouched white paper, crisp edges where the figure meets the white paper, tiny white star-sparkle highlights in the hair and skin, gentle magenta and warm gold accents, only a few small subtle paint splatters nearby, ethereal celestial mood, gallery-quality hand-painted illustration, head-and-shoulders, facing forward toward the viewer, front view portrait, beautiful';
